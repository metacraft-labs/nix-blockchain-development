...
pkgs.stdenv.mkDerivation rec {
  ...
  CC = "gcc";
  CXX = "g++";
  # C_INCLUDE_PATH = "${pkgs.llvmPackages_14.libcxx.dev}/include/c++/v1";

  # C_INCLUDE_PATH = "${pkgs.llvmPackages_14.libcxx.dev}/include/c++/v1:${pkgs.llvmPackages_14.clang-unwrapped.lib}/lib/clang/14.0.1/include:${pkgs.glibc.dev}/include";
  C_INCLUDE_PATH = "${pkgs.gcc11}/lib/gcc/x86_64-unknown-linux-gnu/11.3.0/include-fixed:${pkgs.gcc11}/include/c++/11.3.0/:${pkgs.glibc.dev}/include";
